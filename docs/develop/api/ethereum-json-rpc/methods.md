...
Find below a list of JSON-RPC methods supported on Qubetics, sorted by namespaces.
...
Make sure your `qubeticsd start` call is not using the flag `minimum-gas-prices`,
