...
The Qubetics Testnet is a decentralized blockchain network.
...
Using the Qubetics Testnet provides several benefits for dApp developers.
...
Secondly, the Qubetics Testnet provides a community-driven
...
:::tip
To add Qubetics Testnet to `Metamask`. Here is the details
...
`Block explorer`= https://testnet.qubetics.work/
:::
